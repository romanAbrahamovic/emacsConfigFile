...
;(setq casey-todo-file "/home/.emacs.d/txt/todo.txt")
...
(defun casey-big-fun-c-hook ()
 ...
 (defun casey-header-format ()
     ...
     (insert "   $Date: $\n")
     (insert "   $Revision: $\n")
     (insert "   $Creator: Bighands $\n")
     (insert "   $Notice: (C) Copyright 2017 by MightCore Dev. Team. All Rights Reserved. $\n")
     (insert "   ======================================================================== */\n")
     (insert "\n")
     (insert "#define ")
     (push-mark)
  ...
  (cond ((file-exists-p buffer-file-name) t)
        ...
        ((string-match "[.]sql" buffer-file-name) (casey-source-format)))
